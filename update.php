...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE student SET first_name='$first_name', last_name='$last_name', age='$age', email='$email', address='$address' WHERE ID= $id";
...
<?php 
  if(isset($_GET['user_id']))
     {
         $userid= $_GET['user_id'];
$sql= mysqli_query($conn, "SELECT * FROM student WHERE ID = $userid");
